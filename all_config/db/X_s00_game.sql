...
MySQL - 10.1.8-MariaDB : Database - x_s00_game
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`x_s00_game` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
...
/*Table structure for table `t_hero_0` */
...
/*Table structure for table `t_hero_1` */
...
/*Table structure for table `t_hero_2` */
...
/*Table structure for table `t_hero_3` */
...
/*Table structure for table `t_hero_4` */
...
/*Table structure for table `t_hero_5` */
...
/*Table structure for table `t_hero_6` */
...
/*Table structure for table `t_hero_7` */
...
/*Table structure for table `t_hero_8` */
...
/*Table structure for table `t_hero_9` */
...
CREATE TABLE `t_human` (
  ...
  `hero_tmpl_id` int(11) DEFAULT NULL,
  `curr_exp` int(11) DEFAULT NULL,
  `human_level` int(11) DEFAULT NULL,
  `gold` int(11) DEFAULT NULL,
  `newer_reward_checkout` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`human_uid`),
