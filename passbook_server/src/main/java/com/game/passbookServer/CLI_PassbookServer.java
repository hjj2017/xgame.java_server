package com.game.passbookServer;
...
import com.game.passbookServer.http.JettyHttpProc;
import com.game.passbookServer.jsonConf.PassbookServerConf;

/**
 * Passbook 服务器,
 * 请使用如下命令行启动该服务器 : 
 * <pre>
 * java -cp *.jar com.game.passbookServer.CLI_PassbookServer -c ../all_config/etc/all_config.json -l ../all_config/etc/passbook_server.log4j.properties
 * </pre>
 * <font color='#990000'>
 ...
 * <li>在 "Program Arguments" 下面的文本框里增加 : "-c ../all_config/etc/all_config.json -l ../all_config/etc/passbook_server.log4j.properties" ( 注意 : 只要双引号里面的值 );</li>
